...
export default function Onboarding() {
  ...
  return (
    <div className="min-h-screen bg-white flex items-center justify-center px-3 sm:px-6 py-6 sm:py-12 md:py-16">
      <div className="w-full max-w-5xl">
        ...
        <form onSubmit={handleSubmit} className="space-y-6 sm:space-y-10 md:space-y-12">
          ...
          {/* Height Dropdown */}
          <div className="max-w-md mx-auto mt-6 sm:mt-10 md:mt-12">
          ...
          {/* Submit Button */}
          <div className="max-w-md mx-auto mt-6 sm:mt-12 md:mt-16">
            <button
              type="submit"
